...
const DesignYourPallet = props => {
  ...
  const saveAndContinue = () => {
    ...
    axiosWithAuth()
      .post(`${process.env.REACT_APP_AJAX_URL}/api/pallets/${_id}`, form)
      .then(res => {
        // console.log(res);
  ...
  return (
    <div className="design-your-pallet-container">
      ...
      <div className="type-of-divider">
        <label htmlFor="typeOfDivider" className="form-label">
          Type of Pallet
          <br />
        </label>
        <select
        ...
        <div>
          ...
          <div className="line-1">
            <div className="style-of-runner-container line-1-input">
              <label htmlFor="style-of-runner" className="form-label">
                Style of Stringer
                <br />
              </label>
              <input
            ...
            <div className="length-of-runner-container line-1-input">
              <label htmlFor="length-of-runner" className="form-label">
                Length of Stringer
                <br />
              </label>
              <input
            ...
            <div className="qty-of-runner-container line-1-input">
              <label htmlFor="qty-of-runner" className="form-label">
                Qty. of Stringers
                <br />
              </label>
              <input
          ...
          <div className="line-2">
            <div className="side-access-container line-2-input">
              <label htmlFor="side-access" className="form-label">
                Side Access
                <br />
              </label>
              <select
            ...
            <div className="wood-quality-container line-2-input">
              <label htmlFor="runner-wood-quality" className="form-label">
                Stringer Wood Quality
                <br />
              </label>
              <select
                name="runnerWoodQuality"
                className="form-input"
                id="runner-wood-quality"
                onChange={woodChangeHandler}
              >
                <option>Select an option</option>
          ...
          <div className="bottom-container">
            <div className="line-3-line-4-container">
              <div className="required-pallet-certifications-container">
                <label
                  htmlFor="required-pallet-certifications"
                  className="form-label"
                >
                  Required Pallet Certifications
                  <br />
                </label>
                <select
                  name="requiredPalletCertifications"
                  className="form-input"
              ...
              <div className="special-notes-container">
                <label htmlFor="runner-special-notes" className="form-label">
                  Special Notes for Stringer
                  <br />
                </label>
                <textarea
                  name="runnerSpecialNotes"
                  className="form-input"
                  id="runner-special-notes"
                  cols="30"
                  rows="10"
                  onChange={woodChangeHandler}
          ...
          <h2 className="deck-board-specifications runner-specifications">
          ...
          <div className="line-5">
            <div className="style-of-top-boards line-5-input">
              <label htmlFor="style-of-top-boards" className="form-label">
                Style of Top Boards
                <br />
              </label>
              <input
            ...
            <div className="qty-of-top-boards line-5-input">
              <label htmlFor="qty-of-top-boards" className="form-label">
                Qty. of Top Boards
                <br />
              </label>
              <input
            ...
            <div className="length-of-deck-boards-container line-5-input">
              <label htmlFor="length-of-deck-boards" className="form-label">
                Length of Deck Boards
                <br />
              </label>
              <input
                type="text"
          ...
          <div className="line-5">
            <div className="style-of-bottom-boards line-5-input">
              <label htmlFor="style-of-bottom-boards" className="form-label">
                Style of Bottom Boards
                <br />
              </label>
              <input
                type="text"
            ...
            <div className="qty-of-bottom-boards line-5-input">
              <label htmlFor="qty-of-bottom-boards" className="form-label">
                Qty. of Bottom Boards
                <br />
              </label>
              <input
                type="number"
            ...
            <div className="wood-quality-container line-5-input">
              <label htmlFor="deck-board-wood-quality" className="form-label">
                Deck Board Wood Quality
                <br />
              </label>
              <select
                name="deckBoardWoodQuality"
                className="form-input"
          ...
          <div className="bottom-container">
            <div className="line-3-line-4-container">
              <div className="special-notes-container">
                <label
                  htmlFor="deck-board-special-notes"
                  className="form-label"
                >
                  Special Notes for Deck Board
                  <br />
                </label>
                <textarea
                  name="deckBoardSpecialNotes"
                  className="form-input"
                  id="deck-board-special-notes"
                  cols="30"
                  rows="10"
                  onChange={woodChangeHandler}
      ...
      {form.typeOfDivider === "Plastic" ? (
        <div>
          <div className="line-1">
            <div
              className="style-of-runner-container line-1-input"
              style={{ margin: "0 auto" }}
            >
              <label htmlFor="style-of-runner" className="form-label">
                Style of Pallet
      ...
      <div style={{ margin: "3rem auto 0rem auto", textAlign: "center" }}>
        {form.plastic.styleOfPallet === "Nestable" ? (
          <img
            src={Nestable}
            style={{ height: "400px" }}
            alt="plastic pallet"
        ...
        {form.plastic.styleOfPallet === "Stackable" ? (
          <img
            src={Stackable}
            style={{ height: "400px" }}
            alt="plastic pallet"
        ...
        {form.plastic.styleOfPallet === "Rackable" ? (
          <img
            src={Rackable}
            style={{ height: "400px" }}
            alt="plastic pallet"
        ...
        {form.plastic.styleOfPallet === "Bulk Containers" ? (
          <img
            src={BulkContainer}
            style={{ height: "400px" }}
            alt="plastic pallet"
