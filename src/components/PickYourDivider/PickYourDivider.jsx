...
const PickYourDivider = props => {
  ...
  const saveAndContinue = () => {
    ...
    axiosWithAuth()
      .post(`${process.env.REACT_APP_AJAX_URL}/api/dividers/${_id}`, form)
      .then(res => {
        // console.log(res);
  ...
  return (
    <div className="pick-your-divider-container">
      <h1 className="design-your-box-heading">Step 4 - Pick Your Divider</h1>
      <div className="type-of-divider">
        ...
        <select
          ...
          value={form.corrugated.typeOfDivider}
        ...
        >
          ...
          <option value="Pcorr (Plastic Corrugated)">
        ...
        <div className="corrugated-form-container">
          ...
          <div className="line-1" style={{ marginTop: "0" }}>
            <div className="length-of-box-container line-2-input">
              <label htmlFor="lengthOfBox" className="form-label">
                Length of Box
                <br />
              </label>
              <input
            ...
            <div className="width-of-box-container line-2-input">
              <label htmlFor="widthOfBox" className="form-label">
                Width of Box
                <br />
              </label>
              <input
            ...
            <div className="height-of-box-container line-2-input">
              <label htmlFor="heightOfBox" className="form-label">
                Height of Box
                <br />
              </label>
              <input
          ...
          <div className="line-2" style={{ marginTop: "0" }}>
            <div className="length-of-box-container line-2-input">
              <label htmlFor="numberOfCells" className="form-label">
                Number of Cells
                <br />
              </label>
              <input
            ...
            <div className="width-of-box-container line-2-input">
              <label htmlFor="airPockets" className="form-label">
                Air Pockets?
                <br />
              </label>
              <select
            ...
            <div className="height-of-box-container line-2-input">
              <label htmlFor="allCellsUsed" className="form-label">
                All Cells Used?
                <br />
              </label>
              <select
      ...
      {form.typeOfDivider === "Paper" ? (
        <div className="paper-form-container form-container">
          ...
          <div className="line-1" style={{ marginTop: "0" }}>
            ...
            <div className="height-of-box-container line-2-input">
              <label htmlFor="coated" className="form-label">
                Coated?
                <br />
              </label>
              <select
          ...
          <img
            src={Paper}
            style={{ width: "40%", textAlign: "center", margin: "3rem auto" }}
            alt="3d model of the pallet being created"
          />
        </div>
      ) : null}
        ...
        <div className="paper-form-container form-container">
          ...
          <div className="line-1" style={{ marginTop: "0" }}>
            ...
            <div className="height-of-box-container line-2-input">
              ...
              >
                <option>Select an option</option>
                <option value="Blue Brushed Polyester">
                  Blue Brushed Polyester
                </option>
                <option value="Gray Spunbound Polyester">
                  Gray Spunbound Polyester
                </option>
                <option value="White Spunbound Polyester">
                  White Spunbound Polyester
                </option>
              </select>
            </div>
          </div>
