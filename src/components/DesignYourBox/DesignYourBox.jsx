...
const DesignYourBox = props => {
  ...
  const saveAndContinue = () => {
    ...
    axiosWithAuth()
      .post(`${process.env.REACT_APP_AJAX_URL}/api/boxes/${_id}`, form)
      .then(res => {
        // console.log(res);
  ...
  return (
    <div className="design-your-box-container">
      <h1 className="design-your-box-heading">Step 2 - Design Your Box</h1>
      <div className="line-1">
        <div className="style-of-box-container line-1-input">
          <label htmlFor="styleOfBox" className="form-label">
            Style of Box
            <br />
          </label>
          <select
      ...
      <div className="bottom-container">
        <div className="line-3-line-4-container">
          <div className="special-notes-container">
            {" "}
            <label htmlFor="box-special-notes" className="form-label">
              Special Notes for Box
              <br />
            </label>{" "}
            <textarea
              name="boxSpecialNotes"
              className="form-input"
              id="box-special-notes"
              cols="30"
              rows="10"
              onChange={changeHandler}
      ...
      {form.styleOfBox === "RSC" ? (
        ...
        />
      ) : form.styleOfBox === "5 Panel Folder" ? (
        <img
          src={FivePanel}
          alt="FivePanel"
          style={{
